...
class Master extends CI_Controller
{
  ...
  public function deact_employee($e_id)
  {
   
    $employeeId = 1; 
    $query = $this->db->get_where('employee', array('id' => $e_id));
    $result = $query->row();
  ...
  public function act_employee($e_id)
  {
  ...
  public function accounting()
  {
    $query = "SELECT employee_department.employee_id AS e_id,
                 ...
                 employee.name AS e_name
          FROM employee_department
          LEFT JOIN users ON employee_department.employee_id = users.employee_id
          INNER JOIN employee ON employee_department.employee_id = employee.id
          WHERE employee_department.department_id = 'ACD'
            AND employee.Activate = '1'";
    ...
    $this->load->view('templates/sidebar');
    $this->load->view('templates/topbar');
    $this->load->view('master/accounting/index', $d);
    $this->load->view('templates/table_footer');
  }
  public function adminDep()
  {
    $query = "SELECT employee_department.employee_id AS e_id,
                 employee_department.department_id AS d_id,
                 users.username AS u_username,
          ...
          LEFT JOIN users ON employee_department.employee_id = users.employee_id
          INNER JOIN employee ON employee_department.employee_id = employee.id
          WHERE employee_department.department_id = 'ADM'
          AND employee.Activate = '1'";
    ...
    $this->load->view('templates/sidebar');
    $this->load->view('templates/topbar');
    $this->load->view('master/adminDep/index', $d);
    $this->load->view('templates/table_footer');
  }
  public function resource()
  {
    $query = "SELECT employee_department.employee_id AS e_id,
          ...
          LEFT JOIN users ON employee_department.employee_id = users.employee_id
          INNER JOIN employee ON employee_department.employee_id = employee.id
          WHERE employee_department.department_id = 'HRD'
           AND employee.Activate = '1'";
    ...
    $this->load->view('templates/sidebar');
    $this->load->view('templates/topbar');
    $this->load->view('master/resource/index', $d);
    $this->load->view('templates/table_footer');
  }
  public function it()
  {
    $query = "SELECT employee_department.employee_id AS e_id,
          ...
          LEFT JOIN users ON employee_department.employee_id = users.employee_id
          INNER JOIN employee ON employee_department.employee_id = employee.id
          WHERE employee_department.department_id = 'ITD'
           AND employee.Activate = '1'";
    ...
    $this->load->view('templates/sidebar');
    $this->load->view('templates/topbar');
    $this->load->view('master/it/index', $d);
    $this->load->view('templates/table_footer');
  }
  public function production()
  {
    $query = "SELECT employee_department.employee_id AS e_id,
          ...
          LEFT JOIN users ON employee_department.employee_id = users.employee_id
          INNER JOIN employee ON employee_department.employee_id = employee.id
          WHERE employee_department.department_id = 'PCD'
           AND employee.Activate = '1'";
    ...
    $this->load->view('templates/sidebar');
    $this->load->view('templates/topbar');
    $this->load->view('master/production/index', $d);
    $this->load->view('templates/table_footer');
  }
  public function planner()
  {
    $query = "SELECT employee_department.employee_id AS e_id,
          ...
          LEFT JOIN users ON employee_department.employee_id = users.employee_id
          INNER JOIN employee ON employee_department.employee_id = employee.id
          WHERE employee_department.department_id = 'PLD'
           AND employee.Activate = '1'";
    ...
    $this->load->view('templates/sidebar');
    $this->load->view('templates/topbar');
    $this->load->view('master/planner/index', $d);
    $this->load->view('templates/table_footer');
  }
  public function quality()
  {
    $query = "SELECT employee_department.employee_id AS e_id,
          ...
          LEFT JOIN users ON employee_department.employee_id = users.employee_id
          INNER JOIN employee ON employee_department.employee_id = employee.id
          WHERE employee_department.department_id = 'QCD'
           AND employee.Activate = '1'";
    ...
    $this->load->view('templates/sidebar');
    $this->load->view('templates/topbar');
    $this->load->view('master/quality/index', $d);
    $this->load->view('templates/table_footer');
  }
  public function security()
  {
    $query = "SELECT employee_department.employee_id AS e_id,
          ...
          LEFT JOIN users ON employee_department.employee_id = users.employee_id
          INNER JOIN employee ON employee_department.employee_id = employee.id
          WHERE employee_department.department_id = 'SCD'
           AND employee.Activate = '1'";
    ...
    $this->load->view('templates/sidebar');
    $this->load->view('templates/topbar');
    $this->load->view('master/security/index', $d);
    $this->load->view('templates/table_footer');
  }
  public function store()
  {
    $query = "SELECT employee_department.employee_id AS e_id,
          ...
          LEFT JOIN users ON employee_department.employee_id = users.employee_id
          INNER JOIN employee ON employee_department.employee_id = employee.id
          WHERE employee_department.department_id = 'STD'
           AND employee.Activate = '1'";
    ...
    $this->load->view('templates/sidebar');
    $this->load->view('templates/topbar');
    $this->load->view('master/store/index', $d);
    $this->load->view('templates/table_footer');
  }
  ...
  public function guidance()
  {
    $query = "SELECT employee_department.employee_id AS e_id,
          ...
          LEFT JOIN users ON employee_department.employee_id = users.employee_id
          INNER JOIN employee ON employee_department.employee_id = employee.id
          WHERE employee_department.department_id = 'GUI'
           AND employee.Activate = '1'";
